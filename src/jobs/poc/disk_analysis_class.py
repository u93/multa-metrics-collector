...
class Disk_Analize (Query_Analize):
	def __init__(self, query_file= '', data_file= ''):
		...
		self.metrics = ['disk_dynamic_current', 'disk_dynamic_total', 'disk_dynamic_percent', 'disk_dynamic_insights_status', 'disk_dynamic_io_read_count', 'disk_dynamic_io_write_count', 'disk_dynamic_io_read_bytes', 'disk_dynamic_io_write_bytes', 'disk_dynamic_io_read_time', 'disk_dynamic_io_write_time']
